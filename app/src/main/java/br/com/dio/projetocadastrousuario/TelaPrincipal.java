...
public class TelaPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ocultar barra de ação do aplicativo
        getSupportActionBar().hide();
        IniciarComponentes();

        Button btnConsultarDados = (Button) findViewById(R.id.btn_cadastrar);
        btnConsultarDados.setOnClickListener(new View.OnClickListener()){
            public void onClick (View view){
                Intent intent = new Intent(TelaPrincipal.this, FormUsuarios.class);
            }
        });
    ...
    private void IniciarComponentes(){
        ...
        emailUsuario = findViewById(R.id.textNomeUsuario);
